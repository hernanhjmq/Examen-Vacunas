...
<html>
   ...
   <body>
        ...
        %>
        <h1>EDITAR FORMULARIO DE VACUNAS </h1>
        <form action="Proceso_principal" method="post">
            ...
            <input type="hidden" name="tipo" value="<%= item.getId()%>" required/>
             ...
             Vacuna:  <input type="radio" name="estado_vacuna" value="si" <%= (item.getVacuna().equals("si"))? "checked":"" %> required  /> si
                      <input type="radio" name="estado_vacuna" value="no" <%= (item.getVacuna().equals("no"))? "checked":"" %> required  /> no
                
             <p> <input type = "submit" name = "enviar" value="EDITAR"/> </p>
